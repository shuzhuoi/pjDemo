package com.emgcy.core.system.attachment.web;
...
import com.emgcy.core.system.attachment.bean.BaiduUploaderBean;
import com.emgcy.core.system.attachment.bean.BaiduUploaderBean.UploadBigFile;
import com.emgcy.core.system.attachment.bean.BaiduUploaderBean.UploadCheck;
import com.emgcy.core.system.attachment.bean.BaiduUploaderBean.UploadHandler;
import com.emgcy.core.system.attachment.conf.AttachmentConstant;
...
public class AttachmentController extends AbstractController{
	...
	@ResponseBody
	public BaseMsg uploadBigFile(@RequestParam(value="file") MultipartFile multipartFile,@Validated(UploadBigFile.class) BaiduUploaderBean bean,
	...
	@ResponseBody
	public BaseMsg uploadCheck(@Validated(UploadCheck.class) BaiduUploaderBean bean){
	...
	@ResponseBody
	public BaseMsg uploadHandler(@Validated(UploadHandler.class) BaiduUploaderBean bean,@RequestParam(required=false) String groupUuid){
		if (logger.isInfoEnabled())
